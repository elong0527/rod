...
class TestYamlLoader(unittest.TestCase):
    ...
    def test_resolve_inheritance_no_template(self):
        data = {"key": "value"}
        resolved = self.loader._resolve_inheritance(data)
        self.assertEqual(resolved, data)

    def test_resolve_inheritance_with_template(self):
    ...
    def test_deep_merge_lists_simple(self):
        dict1 = {"l": [1, 2]}
        dict2 = {"l": [2, 3]}
    ...
    def test_deep_merge_lists_keyword_dicts(self):
